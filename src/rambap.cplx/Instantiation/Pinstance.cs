...
{
    /// <summary>
    /// The part this was constructed from.
    /// </summary>
    ...
    internal List<IInstanceConceptProperty> properties { get; } = new();
    ...
    /// </summary>
    public Component User { get; private set; }
    internal void SetUser(Component user)
    {
        if (User != null)
...
#pragma warning disable CS8618  // Doesn't set User
    internal Pinstance(Part template)
